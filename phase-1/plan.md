...
- ✅ AI-Generated Code Only: All implementation will be generated by AI based on this specification
- ✅ Spec-Driven Development: Implementation follows from the formal specification in phase-1/specs/001_console_mvp.md
- ✅ Technology Stack Adherence: Using Python 3.13+, FastAPI & SQLModel (for later phases), in-memory storage for this phase
- ✅ Global Operational Rules: Following PEP 8, using conventional commits, updating spec before code changes
- ✅ Testing & Validation: All features will have mandatory tests as defined in the specification
